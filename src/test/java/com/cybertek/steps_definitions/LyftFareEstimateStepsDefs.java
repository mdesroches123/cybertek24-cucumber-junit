...
public class LyftFareEstimateStepsDefs {
    ...
    public void user_clicks_on_get_estimate_button() throws InterruptedException {
    ...
    public void user_should_see_estimated_prices() throws InterruptedException {
